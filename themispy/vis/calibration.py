...
def annotate_gain_data(gain_data) :
    ...
    * 2 ... Not being solved for.
    ...
    for k,sn in enumerate(station_names) :
        is_gain_set[k,:] = (np.abs(gain_data[sn])-1>1e-10)
...
def plot_station_gain_amplitudes(gain_data, invert=False, add_station_labels=True,  add_quant_labels=False, absolute_time=True, colormap='jet') :
    """
