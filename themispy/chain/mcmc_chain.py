...
def load_deo_summary(annealing_file="Annealing.dat", annealing_summary=None) :
    ...
    Returns:
      (numpy.ndarray,numpy.ndarray,numpy.ndarray): Array of annealing summary information containing Lambda, rt_opt, E, rt_est, AvgR, StdR corresponding to ..., indexed by round; schedule of annealing :math:`\\beta`; :math:`R` for each tempering level and round indexed by [round,tempering level].
    """
    ...
    return annealing_summary_data,beta,R
